...
class HttpClient(Generic[T]):
    ...
    def _handle_response(self, response: requests.Response, out: Optional[Type[T]] = None) -> Optional[T]:
        ...
        return out(response_data)

    def get(self, path: str, params: Dict[str, str] = None, out: Optional[Type[T]] = None) -> T:
        """Send GET request.
    ...
    def post(self, path: str, data: Any = None, out: Optional[Type[T]] = None) -> T:
        """Send POST request.
