...
class SimulatorFast:    
    ...
    def get_vehicle_dis_to_link_boundary(
        self, vehicle_id: str
    ) -> dict:
        """获取车辆到车道边界的距离。
    ...
    def set_vehicle_base_info(self, vehicle_id: str, base_info: Optional[ObjBaseInfo] = None, dynamic_info: Optional[DynamicInfo] = None) -> dict:
    ...
    def set_vehicle_planning_info(self, vehicle_id: str, planning_path: List[Point], speed: List[float]) -> dict:
    ...
    def set_vehicle_position(self, vehicle_id: str, point: Point, phi: Optional[float] = None) -> dict:
    ...
    def set_ped_position(self, ped_id: str, point: Point, phi: Optional[float] = None) -> dict:
    ...
    def set_nmv_position(self, nmv_id: str, point: Point, phi: Optional[float] = None) -> dict:
